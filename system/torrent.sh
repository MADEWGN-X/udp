...
echo ""
echo ""
echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m TORRENT BLOCKER "
#echo -e "\E[44;1;37m        ㅤㅤ        \E[0m"
echo ""
if [[ -e "$arq" ]]; then
	fun_fireoff () {
...
fun_spn1 () {
	...
	echo -ne "\033[1;31mRemoving Firewall Rules\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
read -p "$(echo -e "\033[1;32mDo you want to Disable Firewall Rules?\033[1;33m[y/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 'y' ]]; then
	echo ""	
	fun_spn1
	echo ""
	echo -e "\033[1;33mTorrent blocking successfully removed.\033[0m"
	echo ""
	echo -e "Returns to menu!"
	echo ""
...
echo ""
read -p "$(echo -ne "\033[1;32mDo you want to Enable Firewall Rules?\033[1;33m[y/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 'y' ]]; then
echo ""
echo -ne "\033[1;33mConfirm your ip to continue: \033[1;37m"; read -e -i $IP IP
if [[ -z "$IP" ]];then
echo ""
...
fun_spn2 () {
	...
	echo -ne "\033[1;32mAdding Firewall Rules\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DDone."
}
fun_spn2
echo ""
echo -e "\033[1;33mTorrent Blocking Successfully applied.\033[0m"
echo ""
echo -e "Returns to menu"
sleep 3
menu
